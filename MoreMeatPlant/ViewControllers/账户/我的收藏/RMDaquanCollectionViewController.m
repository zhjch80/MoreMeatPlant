//
//  RMDaquanCollectionViewController.m
//  MoreMeatPlant
//
...
@interface RMDaquanCollectionViewController ()<RefreshControlDelegate>{
    NSInteger pageCount;
    BOOL isRefresh;
    BOOL isLoadComplete;
}
...
@implementation RMDaquanCollectionViewController
@synthesize dataArr;
...
//    [MBProgressHUD showHUDAddedTo:self.view animated:YES];
    ...
    [RMAFNRequestManager myCollectionRequestWithUser:[[RMUserLoginInfoManager loginmanager] user] Pwd:[[RMUserLoginInfoManager loginmanager] pwd] Type:@"4" Page:pageCount andCallBack:^(NSError *error, BOOL success, id object) {
